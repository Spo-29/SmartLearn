            ...
            <div className="row">
              <div className="col-md-12 mt-4">
                <div className="border bg-white rounded-3 p-4">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi. Suspendisse potenti. Vivamus tincidunt, eros et tincidunt tincidunt, libero turpis posuere urna, ut consectetur justo erat a arcu. Fusce eget risus id mauris
                    tincidunt posuere. Curabitur euismod, magna ut tristique venenatis, erat velit venenatis felis, at varius odio elit nec augue. Sed et sapien vitae justo dapibus dictum.{' '}
                  </p>
                ...
                <div className="border bg-white rounded-3 p-4">
                  ...
                  <div className="mt-4">
                    <div className="d-flex align-items-start mb-4 border-bottom pb-3">
                      ...
                      <div>
                        <h6 className="mb-0">
                          Mohit Singh <span className="text-muted fs-6">Jan 2, 2025</span>
                        </h6>
                    ...
                    <div className="d-flex align-items-start mb-4  pb-3">
                      ...
                      <div>
                        <h6 className="mb-0">
                          mark Doe <span className="text-muted fs-6">Jan 10, 2025</span>
                        </h6>
                        <div className="text-warning mb-2">
                          <Rating initialValue={rating} size={20} />
                        </div>
